...
plt.savefig('Output_Files/Bayesian_Images/PosteriorMean_EnsembleMean_'+str(date_generated[lastDay])+ '.png',dpi=600,bbox_to_inhes='tight',facecolor='w')
...
plt.savefig('Output_Files/Bayesian_Images/PosteriorMean_'+str(date_generated[lastDay])+ '.png',dpi=600,bbox_to_inhes='tight',facecolor='w')
