...
###################################### Update Input Files ###################################
with open('Data_Files/sse324.pkl', 'wb') as f:
    pickle.dump(SSE, f)

with open('Data_Files/day324.pkl','wb') as f:
    pickle.dump(latestDay,f)       
        
###################################### Update Output Files ###################################
with open('Data_Files/wm324.pkl', 'wb') as f:
    pickle.dump(weighted_mean, f)

with open('Data_Files/wub324.pkl','wb') as f:
    pickle.dump(weighted_ub,f)

with open('Data_Files/wlb324.pkl','wb') as f:
    pickle.dump(weighted_lb,f)

with open('Data_Files/wr324.pkl','wb') as f:
    pickle.dump(weightr,f)

with open('Data_Files/ensemblemean324.pkl','wb') as f:
    pickle.dump(ensemble_mean,f)
with open('Data_Files/ensembleub324.pkl','wb') as f:
    pickle.dump(ensemble_ub,f)
with open('Data_Files/ensemblelb324.pkl','wb') as f:
    pickle.dump(ensemble_lb,f)

with open('Data_Files/ensemblesem324.pkl','wb') as f:
    pickle.dump(ensemble_sem,f)