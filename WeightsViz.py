...
name = "Output_Files/Bayesian_Images/WeightsRearr_Day_" + str(date_generated[lastDay])+".png"
...
name = "Output_Files/Bayesian_Images/Weights_Day_" + str(date_generated[lastDay])+".png"
plt.savefig(name,dpi=600,bbox_inches='tight')