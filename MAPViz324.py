...
labels = ['IENV-33P,ABW-150','IENV-33P,ABW-180','IENV-66P,ABW-150','IENV-66P,ABW-180','IENV-100P,ABW-150','IENV-100P,ABW-180']
...
plt.legend()
plt.tight_layout()
plt.savefig('Output_Files/Bayesian_Images/324_PosteriorMean_EnsembleMean_MAP'+str(date_generated[lastDay])+ '.png',dpi=600,bbox_to_inhes='tight',facecolor='w')
...
plt.legend()
plt.tight_layout()
plt.savefig('Output_Files/Bayesian_Images/324_MAP'+str(date_generated[lastDay])+ '.png',dpi=600,bbox_to_inhes='tight',facecolor='w')